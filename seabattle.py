...
class BoardOutException(BoardException):
    def __str__(self):
        return "Выстрел за пределы поля боя! Повторите попытку!"


class BoardUsedException(BoardException):
    def __str__(self):
        return "Вы стреляли в эту клетку! Повторите попытку!"
...
class Board:
    def __init__(self, vis=False, size = 6):
        self.vis = vis
        self.size = size
        self.count = 0
...
class Game:
    ...
    def greetings(self):
        ...
        print("--------------Морской бой------------")
        print("В твоем распоряжении 7 кораблей: Один трехпалубный,")
        print("два двухпалубных и четыре однопалубных")
